...
struct StoryBrain {
    ...
    func getLabel() -> String {
        // To get the current story Label
        return stories[storyCounter].storyTitle
    }
    
    func btn1() -> String {
        // To print the 1st choie of the current story Label
        return stories[storyCounter].choice1
    }
    
    func btn2() -> String {
        // To print the 2st choie of the current story Label
        return stories[storyCounter].choice2
    }
    
    mutating func nextStory(userChoice : String) {
        // Used to displaythe next story acording to the choice user made
        let currentStory = stories[storyCounter]
        if userChoice == currentStory.choice1 {
            storyCounter = currentStory.choice1Destination
//            print(currentStory.choice1)
        } else if (userChoice == currentStory.choice2) {
            storyCounter = currentStory.choice2Destination
//            print(currentStory.choice2)
        }
    }
